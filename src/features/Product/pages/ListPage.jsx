...
function ListPage(props) {
    ...
    const checkAllFilter = (arr)=>{
        ...
        if(filters._filterprice.salePrice_gte != 0 && filters._filterprice.salePrice_lte == 0){
            ...
            (arr = arr.filter(x=> (x.salePrice >= filters._filterprice.salePrice_gte 
                && x.salePrice<=filters._filterprice.salePrice_lte)));
    ...
    useEffect(()=>{
        (async ()=>{
            try{
                ...
                // set(ref(db, 'list-product' ),listproduct);
                ...
                onValue(ref(db,'list-product'), (snapshot) => {
                    ...
                    if (data !== null) {
                        ...
                        if(filters._filtercategory || (filters._filterprice.salePrice_gte !=0 || filters._filterprice.salePrice_lte !=0)
                            || filters._filterpromotion || filters._filterfreeship || filters._filtersearch !==''){
                ...
                <Grid container spacing={1}>
                    ...
                    <Grid item className={classes.right}>
                        <Paper evalation={0}>
                            ...
                            {loading ? <ProductSkeletonsList length={9}/> 
                            : <ProductList data={productList}/>}

                            <Box className={classes.pagination}>
                                <Pagination color="primary" count={Math.ceil(pagination.total/ pagination.limit)} 
