    ...
    return (
        <Box >
            <Box className={classes.box2}>
                <Typography component="h1" variant="h4" align="left">{name}</Typography>
                <Typography variant="body2" className={classes.description} align="left">{shortDescription}</Typography>
            </Box>
